...
import { BiFolderPlus, BiHeart, BiSolidFolder, BiSolidFolderPlus, BiSolidHeart } from 'react-icons/bi'
...
const addToFavourites = async(e)=>{
  ...
  if(isError){
    ...
    <div className="w-full h-[60vh] flex flex-col items-center justify-center">
      <p className="text-lg text-txtPrimary font-semibold">Error while fetching the data...Please refresh</p>
    </div>
      )
  }
    ...
    <div className="w-full flex items-center justify-start flex-col px-4 py-12">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="col-span-1 lg:col-span-4 w-full flex flex-col items-center justify-start px-3 gap-6">
          {/* discover more */}
          <div className="w-full h-72 bg-blue-200 rounded-md overflow-hidden relative" style={{background : "url(https://cdn.pixabay.com/photo/2024/01/20/12/59/blue-tit-8521052_640.jpg)",
